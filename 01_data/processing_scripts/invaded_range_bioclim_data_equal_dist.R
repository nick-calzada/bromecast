...
genotype_locations <-
  read.csv(here('01_data', 'data', 'bioclim_and_other', 'BioclimateOfOrigin_AllGenotypes.csv'), header=T) %>%
...
genotype_codes <-
  read.csv(here('01_data', 'data', 'bioclim_and_other', 'BRTEcg_genotypesCode.csv'), header = T) %>%
